...
st.info('Cette appli est mon premier concept, elle est susceptible de plus fonctionner car tiktok empêche le scrapping ! Merci à ceux qui voudront me soutenir par des propositions', icon="😪")
